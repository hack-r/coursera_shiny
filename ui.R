...
shinyUI(
  ...
  # Application title
  titlePanel("Stackoverflow.com Answer Predictor",
             windowTitle = "SO Answer Predictor"),
  h5("Developing Data Products class project"),
...
# mainPanel ---------------------------------------------------------------
    ...
    mainPanel(
      tabsetPanel(
        tabPanel("Info", textOutput("info"), textOutput("info1"), 
                 textOutput("info2"), textOutput("info3")),
